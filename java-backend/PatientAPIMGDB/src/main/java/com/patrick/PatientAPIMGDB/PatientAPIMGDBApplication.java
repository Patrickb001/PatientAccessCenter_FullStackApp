	...
	CommandLineRunner runner(
		...
		return args -> {
			Patient patient = new Patient( "https://randomuser.me/api/portraits/women/71.jpg" ,"Jamila Ahmed",
					...
					List.of("Heart Failure", "Fracture Ankle"), List.of("Lisinopril", "Furosemide", "Diltiazem", "Lovastatin"), List.of("121/74", "65"));
			...
			Patient patient2 = new Patient( "https://randomuser.me/api/portraits/men/62.jpg","John Adams", "1985, 12, 1",
					...
					List.of("Indomethacin", "Morphine", "Ursodiol", "Tenofovir"), List.of("131/80", "85")
			);


			Patient patient3 = new Patient("https://randomuser.me/api/portraits/men/83.jpg", "Chris Smith", "1990, 11, 21",
					"184", "5'7", Gender.MALE, "Myocarditis", "27924 Bergnaum Station, Houston, TX, 76570", "chrissmith12@gmail.com",
					"211-323-6395", "392-500-0229", "373-760-3054", List.of(""), List.of("Morphine", "Aspirin", "Furosemide", "Amiodarone"), List.of("150/80", "88"));
