	...
	CommandLineRunner runner(
		...
		return args -> {
			Patient patient = new Patient( "https://randomuser.me/api/portraits/women/71.jpg" ,"Jamila Ahmed",
					...
					List.of("Heart Failure", "Fracture Ankle"), List.of("Lisinopril", "Furosemide", "Diltiazem", "Lovastatin"), new String[]{"121/74", "65"}, List.of("CMP", "UA", "CBC", "Vital Signs", "Blood Glucose", "Kidney Ultrasound"));
			...
			Patient patient2 = new Patient( "https://randomuser.me/api/portraits/men/62.jpg","John Adams", "1985, 12, 1",
					...
					List.of("Indomethacin", "Morphine", "Ursodiol", "Tenofovir"), new String[]{"131/84", "80"}, List.of("CT Abdomen & Pelvis", "LFT", "CBC", "CMP", "Vital Signs", "Abdominal Ultrasound"));
			...
			Patient patient3 = new Patient("https://randomuser.me/api/portraits/men/83.jpg", "Chris Smith", "1990, 11, 21",
					...
					List.of("Morphine", "Aspirin", "Furosemide", "Amiodarone"), new String[]{"151/80", "88"},  List.of("EKG", "CBC", "Troponin", "CKMB", "Vital Signs", "CHEM8" , "Chest X-ray"));
